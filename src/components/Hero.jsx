    ...
    <section class="hero-section">
      ...
      <div class="hero-container">
        ...
        <div class="hero-left-col">
          <div class="badge-row">
            <div class="hero-pill pill-gold">
              <svg class="icon-shield-gold" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <h1 className="hero-headline">
            ...
            <br />Admission in Top NCTE Approved Universities
          </h1>
          ...
          <div class="hero-features-grid">
            <div class="feature-card">
              ...
              <span class="feature-card-text">Zero Donation / Direct University Fees</span>
            </div>

            <div class="feature-card">
              <div class="card-icon-wrapper bg-icon-teal">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                  <path d="M9 12l2 2 4-4" />
                </svg>
              </div>
              <span class="feature-card-text">Recognized by UGC & NCTE (Govt)</span>
            </div>

            <div class="feature-card">
              <div class="card-icon-wrapper bg-icon-purple">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                  <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" />
                  <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" />
                </svg>
              </div>
              <span class="feature-card-text">Free Study Books, Kits & Online Classes</span>
            </div>

            <div class="feature-card">
              <div class="card-icon-wrapper bg-icon-orange">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                  <path d="M22 10v6M2 10l10-5 10 5-10 5z" />
                  <path d="M6 12v5c3 3 9 3 12 0v-5" />
                </svg>
              </div>
              <span class="feature-card-text">Guaranteed Degree Completion Support</span>
            </div>
          </div>

          <div class="hero-cta-row">
            <a href="tel:+919990612020" class="btn-orange-call">
            ...
            <div class="counselors-online-pill">
              <span class="status-dot pulsing-green"></span>
