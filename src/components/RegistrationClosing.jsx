...
export default function RegistrationClosing() {
  return (
    <section className="registration-closing-section">
      <div className="registration-closing-container">
        <div className="closing-badge">
          <svg className="icon-trophy" viewBox="0 0 24 24" fill="currentColor">
        ...
        <h2 className="closing-title">Don’t Miss An Academic Year! Secure Your Seat Today</h2>
        ...
        <div className="closing-actions-row">
          <a href="tel:+919990612020" className="btn-closing-call">
          ...
          <a href="https://wa.me/919990612020" target="_blank" rel="noopener noreferrer" className="btn-closing-whatsapp">
